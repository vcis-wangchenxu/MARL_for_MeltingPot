"""
~/anaconda3/envs/DLRL/lib/python3.11/site-packages/pygame/pkgdata.py
...
def resource_exists(package, resource_name):
    ...
    try:
        return importlib.resources.files(package).joinpath(resource_name).exists()
    except Exception:
        return False

def resource_stream(package, resource_name):
    """Return a binary stream for the resource."""
